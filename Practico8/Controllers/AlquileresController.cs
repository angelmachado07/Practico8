...
namespace Practico8.Controllers
{
    public class AlquileresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCopia,IdCliente,FechaAlquiler,FechaTope,FechaEntrega")] Alquilere alquilere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,IdCopia,IdCliente,FechaAlquiler,FechaTope,FechaEntrega")] Alquilere alquilere)
        {
            if (id != alquilere.Id)
            {
                return NotFound();
